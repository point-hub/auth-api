...
import { RetrieveAllApiKeyUseCase } from '../use-cases/retrieve-all.use-case'

export const retrieveAllApiKeyController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await RetrieveAllApiKeyUseCase.handle(
