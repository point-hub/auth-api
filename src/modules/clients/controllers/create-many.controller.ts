...
export const createManyClientController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await CreateManyClientUseCase.handle(controllerInput.httpRequest['body'], {
      schemaValidation,
