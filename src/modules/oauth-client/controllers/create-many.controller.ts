...
export const createManyOAuthClientController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await CreateManyOAuthClientUseCase.handle(
