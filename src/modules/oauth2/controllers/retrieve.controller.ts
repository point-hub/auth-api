...
import { RetrieveOAuth2UseCase } from '../use-cases/retrieve.use-case'

export const retrieveOAuth2Controller: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await RetrieveOAuth2UseCase.handle(
