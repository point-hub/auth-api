...
import { RetrieveApiKeyUseCase } from '../use-cases/retrieve.use-case'

export const retrieveApiKeyController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
    ...
    const response = await RetrieveApiKeyUseCase.handle(
