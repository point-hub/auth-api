...
import { RegenerateApiKeyUseCase } from '../use-cases/regenerate.use-case'

export const regenerateApiKeyController: IController = async (controllerInput: IControllerInput) => {
  let session
  try {
